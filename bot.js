...
client.on('message', message => {
	...
	fs.writeFile("data.txt", message.createdAt.toString().concat("|", "text", message.member.user.id.toString, "|", message.member.user.username.toString, "|", message.channel.id.toString(), "|", message.channel.toString(), "|", message.content.length), function(err) {
			if(err) {
